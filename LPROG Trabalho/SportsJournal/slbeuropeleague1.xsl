			...
			<html>
				...
				<div id="menubar" align="center">
					...
					<div id="title" style="position:relative; top:30px">
						...
						<p align="center">(Total news: <xsl:value-of select="count(sportsJournal/news[sport='Football' and championship/name='Europe League' and clubs/club/shortname='SLB' and clubs/club/position=1 ])"/>)</p>
						<br /><hr /><br />
					</div>
					...
					<div id="links" style="position:relative; top:30px;">
						...
						<!-- table with links -->
							<table border="2" align="center">
								...
								<tr>
									<td>
										<xsl:for-each select="sportsJournal/news[sport='Football' and championship/name='Europe League' and clubs/club/shortname='SLB' and clubs/club/position=1 ]">
