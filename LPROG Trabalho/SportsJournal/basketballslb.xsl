			...
			<html>
				...
				<div id="menubar" align="center">
					...
					<div id="title" style="position:relative; top:30px">
						...
						<p align="center">(Total news: <xsl:value-of select="count(sportsJournal/news[sport='Basketball' and clubs/club/shortname='SLB'])"/>)</p>
						<br /><hr /><br />
					</div>
					...
					<div id="links" style="position:relative; top:30px;">
						...
						<!-- table with links -->
							<table border="2" align="center">
								...
								<tr>
									<td>
										<xsl:for-each select="sportsJournal/news[sport='Basketball' and clubs/club/shortname='SLB']">
