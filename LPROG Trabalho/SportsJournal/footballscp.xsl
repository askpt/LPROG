			...
			<html>
				...
				<div id="menubar" align="center">
					...
					<div id="title">
						...
						<p align="center">(Total news: <xsl:value-of select="count(sportsJournal/news[sport='Football' and clubs/club/shortname='SCP'])"/>)</p>
						<br /><hr /><br />
					</div>
					...
					<div id="links">
						...
						<!-- table with links -->
							<table border="2">
								...
								<tr>
									<td>
										<xsl:for-each select="sportsJournal/news[sport='Football' and clubs/club/shortname='SCP']">
