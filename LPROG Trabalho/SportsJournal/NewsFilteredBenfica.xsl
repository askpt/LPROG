			...
			<html>
				...
				<body>
					...
					<div id="title">
						...
						<p align="center">(Total news: <xsl:value-of select="count(sportsJournal/news[clubs/club/shortname='SLB'])"/>)</p>
						<br /><hr /><br />
					</div>
					...
					<div id="links">
						...
						<!-- table with links -->
							<table border="2">
								...
								<tr>
									<td>
										<xsl:for-each select="sportsJournal/news[clubs/club/shortname='SLB']">
